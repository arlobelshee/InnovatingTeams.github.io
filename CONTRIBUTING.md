# Contributing to Innovating Teams Inc. Projects
...
As contributors and maintainers of Innovating Teams Inc. projects, we pledge to respect everyone who contributes by posting issues, updating documentation, submitting pull requests, providing feedback in comments, and any other activities.

Communication through any Innovating Teams Inc. channels (GitHub, Gitter, mailing lists, Google+, Twitter, etc.) must be constructive and never resort to personal attacks, trolling, public or private harassment, insults, or other unprofessional conduct.

We promise to extend courtesy and respect to everyone involved in this project regardless of gender, gender identity, sexual orientation, disability, age, race, ethnicity, religion, or level of experience. We expect anyone contributing to Innovating Teams Inc. projects to do the same.

If any member of the community violates this code of conduct, the maintainers of the Innovating Teams Inc. projects may take action, removing issues, comments, and PRs or blocking accounts as deemed appropriate.

If you are subject to or witness unacceptable behavior, or have any other concerns, please email us at conduct@innovatingteams.com.

## <a name="question"></a> Got a Question or Problem?

If you have questions about how to use any Innovating Teams Inc. project library, please direct these to the Gitter Channels or StackOverflow.
...
* **content**: Changes only to descriptive content
...
The scope could be anything specifying the location of the commit change. For example `index-page` or `logger`.
...
Please sign our Contributor License Agreement (CLA) before sending pull requests. For any code changes to be accepted, the CLA must be signed. It's a quick process, we promise! You can [sign the CLA online](http://goo.gl/forms/j2i4eimzwH).

> Note: This document is based on the Innovating Teams Contributor doc. Thanks to that team for putting it together.